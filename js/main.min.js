...
($.fn.swipe = function (t) {
  return (
    (t = $.extend({ left: null, right: null }, t)),
    this.each(function () {
      if (t.left || t.right) {
        var e = 0,
          i = 0,
        ...
        $(this).on("touchstart", function (t) {
          ...
          $(this).on("touchmove", function (t) {
            return (
              !(
                !1 === o &&
                ((a = e - (t.pageX || t.touches[0].pageX)),
                (n = i - (t.pageY || t.touches[0].pageY)),
                Math.abs(a) > 10 && Math.abs(n) < 10)
              ) || ((o = a > 0 ? "left" : "right"), !1)
            );
          }),
          $_window.on("touchend", function (e) {
            o && t[o] && t[o](), (a = 0), (n = 0), (o = !1);
          });
      }
    })
  );
  ...
  $_document.on("DOMContentLoaded", function () {
    ...
    touch_device && y.addClass("touch-device"),
      ...
      o && new Headroom(t[0], { offset: 120, tolerance: { up: 5 } }).init(),
      t.hasClass("header-shadow-scroll") &&
        ((d = function () {
        ...
        if ($(this).has("ul").length) {
          ...
          t
            .on("mouseenter", function () {
              e.outerWidth() + e.offset().left + 20 - a.offset().left >
                a.width() && e.addClass("nav-left");
            })
            .on("mouseleave", function () {
              e.removeClass("nav-left");
            }),
            t.find("> .button").length
              ? e
                  .addClass("nav-button")
                  .css("minWidth", t.outerWidth() - 20 + "px")
              : e.css("minWidth", t.outerWidth() + 20 + "px");
        }
      ...
      e.length &&
        ((l = $('<div id="nav-overlay-background"></div>')),
        ...
        (u =
          (t.hasClass("header-light")
            ? "light"
            : t.hasClass("header-gray") && "gray") ||
          (t.hasClass("header-dark") && "dark")),
        (f = $.trim(
          (s ? "nav-overlay-visible" : "") + " " + (u ? "nav-overlay-" + u : "")
        )) && (h.addClass(f), c.addClass(f), r.addClass(f), l.addClass(f)),
        c.appendTo(a).on("click", function () {
          y.prepend(l, h), $_window.scrollTop(0);
        }),
        r.on("click", function () {
          l.detach(), h.detach();
        })),
      ...
      (v = p.data()) &&
        v.dismissible &&
        (v.title && Cookies.get("notification-" + v.title)
          ? p.remove()
          : (s && p.addClass("notification-dismiss-align"),
            $(
              '<i id="notification-dismiss" class="material-icons" style="color: #4a5669;">close</i>'
            )
              .prependTo(p.find("div.container"))
              .on("click", function () {
                p.addClass("notification-hide"),
                  v.title &&
                    Cookies.set("notification-" + v.title, 0, {
      ...
      $("span.type-text").each(function () {
        var t,
          ...
          i = $.trim(e.text()),
          a = e.data("type-text"),
          n = 1e3 * (e.data("type-text-speed") || 0.1),
          o = 1e3 * (e.data("type-text-delay") || 2),
          s = !!e.data("type-text-loop"),
          d = 0,
          l = 0,
          c = 0,
          r = !1,
        ...
        a &&
          ((a = a.split(";")),
          $.map(a, $.trim),
          i && (a.unshift(i), (c = a[l].length), (r = !0)),
          (d = a.length) &&
            ((t = function () {
              (c < a[l].length || r) &&
                setTimeout(
      ...
      $(
        ...
        var t = $(this),
          ...
          o =
            "checkbox" === e
              ? t
              : t.closest("form").find('input[name="' + t.attr("name") + '"]');
        n.on("click", function () {
          !1 === t.is(":disabled") &&
            (t
              .filter(':not([type="radio"]:checked)')
              .prop("checked", !1 === t.is(":checked")),
            o.trigger("change"));
        }),
          ...
          1 === i.find('input[type="' + e + '"]').length &&
            i.addClass(e + "-style-block"),
      ...
      $("div.tab-group").each(function () {
        var t = $(this),
          ...
          a = Math.max(
            ...
            i
              .filter(
                location.hash && i.filter(location.hash).length
                  ? location.hash
                  : ".active"
              )
              .index()
        ...
        h.length > 0 &&
          h.on("click", function (e) {
            var i,
              ...
              v,
              g = $(this).attr("href");
            $.inArray(g.split(".").pop(), ["jpg", "jpeg", "png", "gif"]) > -1 &&
              ((i = $('<div id="gallery-overlay"></div>')),
              (a = $(
              ...
              h.each(function (e) {
                var i,
                  ...
                  o = $(this).attr("href"),
                  l = $(this).attr("title");
                $.inArray(o.split(".").pop(), ["jpg", "jpeg", "png", "gif"]) >
                  -1 &&
                  ((i = $('<div class="loading hide"></div>')),
              ...
              a.on("click", function () {
                $_window.off("keydown", u), i.remove();
              }),
              l.length > 1 &&
                ((f = function (e) {
                  var i,
                    a = $("#gallery-overlay-" + t + "-" + e),
                    c = a.parent().find("div.loading"),
                    r = a.data("src"),
                    h = a.data("title");
                  r &&
                ...
                c > 0 ? f(c) : n.hide(),
                touch_device && i.swipe({ left: v, right: p }),
                i.append(n, o),
                n.on("click", p),
                o.on("click", v)),
              e.preventDefault());
          ...
          u.length > 1 &&
            ...
            (o = function (t, e) {
              t.imagesLoaded(function () {
                c[e ? "addClass" : "removeClass"]("gallery-animate").css(
                  "height",
                  t.height() + "px"
                );
              });
            ...
            touch_device && c.swipe({ left: l, right: d }),
            e.on("click", d),
            i.on("click", l),
      ...
      $("select.product-term-select").each(function (t) {
        var e = $(this),
          i = $(
            'select.product-term-select[data-sync="' + e.data("sync") + '"]'
          ),
          ...
          s = function (t) {
            if (!1 === e.is(":disabled")) {
              ...
              l && n.length && n.attr("href", l),
                s &&
                  o.length &&
                  (o(s), d && o.append('<span class="term">' + d + "</span>")),
                i.length &&
                  t &&
                  t.originalEvent &&
                  i
                    .find("option:eq(" + a.index() + ")")
                    .prop("selected", !0)
                    .change();
            }
          };
      ...
      $("div.product-slider").each(function (t) {
        var e,
          ...
          d = $(this),
          l = d.find("> ul"),
          c = (l.first().find("li").length, l.filter(".active").length);
        l.length > 0 &&
          ((e = 100 / l.length),
                ...
                ? i.each(function () {
                    $(this).find("> ul").removeClass("active"),
                      $(this)
                        .find("div.range")
                        .css("width", e * r + "%"),
                      $("#" + $(this).attr("id") + "-" + (r - 1)).addClass(
                        "active"
                      );
                  })
                : (l.removeClass("active"),
                  o.css("width", e * r + "%"),
                  $("#product-slider-" + t + "-" + (r - 1)).addClass("active"))
              : o.css("width", d + "%");
          }),
          l.each(function (i) {
            ((0 === c && 0 === i) || (1 === c && $(this).is(".active"))) &&
              ($(this).addClass("active"),
              o.css("width", e * (i + 1) + "%").append(n)),
              $(this).attr("id", "product-slider-" + t + "-" + i),
              a.append(
                '<div class="segment" style="width: ' + e + '%;"></div>'
              );
          }),
        ...
        e.length &&
          ...
          n.each(function (t) {
            var e,
              ...
              c,
              r = $(this),
              h = $('<div class="configurator-group"></div>'),
              u = $('<div class="slider clear"></div>'),
              f = $('<div class="handle"></div>'),
              p = $('<div class="range"></div>'),
              v = $('<span class="value"></span>'),
              g = Number(r.val()),
              m = Number(r.data("min")),
              w = Number(r.data("max")),
              _ = Number(r.data("step")),
              y = (Number(r.data("price")), r.data("title")),
              C = r.data("title-plural"),
              b = r.data("description");
            if (
              (isNaN(_) && (_ = m),
              (s = 100 / (e = w / _)),
              e === parseInt(e, 10))
              ...
              for (
                d = function (t) {
                  if (
                    (t.el_configurator_title.length &&
                      ((t.val_configurator_input =
                        t.val_configurator_input +
                        (t.val_configurator_title_plural &&
                        1 != t.val_configurator_input
                          ? t.val_configurator_title_plural
                          : t.val_configurator_title)),
                      t.el_configurator_title(t.val_configurator_input)),
                    ...
                    t.el_product_configurator_input.each(function () {
                      ...
                      t.el_product_configurator_total(
                        t.val_product_configurator_currency.replace(
                          "%",
                          Math.round(e * Math.pow(10, 4)) / Math.pow(10, 4)
                        )
                      );
                  }
                },
                ...
                g == (c + 1) * _ && p.css("width", s * (c + 1) + "%").append(f),
                  u.append(
                    '<div class="segment" style="width: ' + s + '%;"></div>'
                  );
              u.on("click", function (t) {
                ...
                r.before(
                  h(v).append(b ? '<span class="label">' + b + "</span>" : "")
                ),
      ...
      $("pre.pre-code").each(function () {
        var t,
          ...
          a = i.split("\n").length;
        if (a) {
          for (t = 1; t <= a; t++) e.append("<li>" + t + "</li>");
          $(this)
        ...
        var t = $(this),
          ...
          a = function () {
            var a = t.width(),
              n = 0;
            e !== a &&
              ((n = Math.round((i / e) * a)), t.css("height", n + "px"));
          };
        $_window.on("resize", a), a();
      }),
      $("table").each(function () {
            ...
            t.each(function (t) {
              ...
              i.length &&
                ...
                i
                  ...
                  .prepend('<span class="responsive-th">' + a + "</span>");
            });
        }
      ...
      $("div.grid").each(function () {
        var t,
          e = $(this),
          i = e.find("> div.grid-item"),
          a = e.closest("div.container"),
          n = e.data("grid-columns"),
          o = e.data("grid-gap");
        i.length &&
          ((n = n || 3),
          (o = o >= 0 ? o : 60),
          (t = function () {
            ...
            $.each([512, 768, 1024], function (t, e) {
              if (l <= e)
                return (
                  (s = Math.max(n - (3 - t), 1)), (d = Math.min(o, 30)), !1
                );
            }),
      ...
      $("section.content-row").each(function () {
        var e,
          ...
          n,
          s = $(this),
          d = s.hasClass("content-row-half-height"),
          l = s.hasClass("content-row-full-height");
        (d || l) &&
          ((e = 0),
          (i = l ? 1 : 2),
          ...
          (n = function () {
            s.css("height", "auto"),
              (e = Math.round(
                ($_window.height() -
                  (a ? s.offset().top : o ? 0 : t.outerHeight())) /
                  i
              )) > s.outerHeight() && s.css("height", e + "px");
          }),
          $_window.on("resize", n),
          $_window.on("load", n),
          n());
      ...
      $("div.content-slider").each(function (t) {
        var e,
          ...
          h = $(this),
          u = h.find("> .slide"),
          f = $('<div class="content-slider-inner"></div>'),
          p = u.length;
        p &&
          ((e = function () {
            var t = 0,
          ...
          p > 1
            ? ((i = 0),
              ...
              (s = function (e, i, o) {
                o && n && clearInterval(n),
                  a &&
                    ($("#content-slider-nav-" + t + "-" + e).removeClass(
                      "active"
                    ),
                ...
                if (a) {
                  ...
                  e === i && n.addClass("active"),
                    s &&
                      ...
                      d()),
                    n
                      .attr("id", "content-slider-nav-" + t + "-" + e)
                      .data("slide", e),
                    o.append(n);
                }
                e === i &&
              ...
              a &&
                (h.addClass("content-slider-has-nav").prepend(o),
                o.find("li").on("click", function () {
                  s(i, (i = $(this).data("slide")), !0);
                })),
              h.data("nav-directional") &&
                ((c = $(
                ...
                c.on("click", d),
                r.on("click", l)),
              touch_device && h.swipe({ left: l, right: d }),
              n &&
                (n = setInterval(function () {
                  s(i, (i = i + 1 > p - 1 ? 0 : i + 1), !1);
                }, 1e3 * n)))
            : u.removeClass("active").addClass("active-first"),
          h.append(f.append(u)),
          $_window.on("resize", e),
          $_window.on("load", e),
          e());
      ...
      $("div.content-background").each(function () {
        var t,
          ...
          o,
          s = $(this),
          d = s.find("i, svg, img, video, iframe");
        d.length &&
          ((t = d.is("i")),
          ...
          t
            ? ((t = function () {
                ...
                d.css(
                  "font-size",
                  Math.round(Math[i ? "min" : "max"](t, e)) + "px"
                );
              }),
              $_window.on("resize", t),
              $_window.on("load", t),
            ...
            : e &&
              ((e = function () {
                s.removeClass("object-fit-width"),
                  ...
                  i
                    ? (s.outerWidth() < d.outerWidth() &&
                        s.addClass("object-fit-width"),
                      s.outerHeight() < d.outerHeight() &&
                        s.addClass("object-fit-height"))
                    : s.outerHeight() > d.outerHeight() &&
                      s.addClass("object-fit-height");
              }),
              d.on("loadeddata", e),
              ...
              e()),
          a &&
            ((n = s.closest("section.content-row")),
            (o = null),
            (a = function () {
              var t = n.offset().top,
                e = n.outerHeight(),
      ...
      $("a.video-overlay").each(function () {
        ...
        n &&
          ...
          (t || e || i) &&
            (a.find("> img").length &&
              (a.addClass("video-overlay-has-icon"),
              a.append(
                '<i id="video-overlay-icon" class="material-icons">play_arrow</i>'
              )),
            (t =
              !!t && "https://www.youtube.com/embed/" + t[1] + "?autoplay=1"),
            (e =
              !!e && "https://player.vimeo.com/video/" + e[1] + "?autoplay=1"),
            (i = !!i && n),
      ...
      $("a.iframe-overlay").each(function () {
        ...
        e &&
          t.on("click", function (t) {
            ...
            i && a && (s.attr("width", i), s.attr("height", a)),
              n.append(s),
      ...
      $("div.modal").each(function () {
        var t,
          ...
          i,
          a = $(this),
          n = a.find("> div.modal-header"),
          o = a.find("> div.modal-content"),
          s = $('<div id="modal-overlay"></div>'),
          d = $('<div class="modal-container"></div>'),
          l = $('<i class="material-icons modal-dismiss">close</i>'),
          c = a.data("modal"),
          r = a.data("modal-show"),
          h = a.data("modal-dismissible");
        n.length &&
          o.length &&
          c &&
          ((t = function (t) {
          ...
          a.hasClass("modal-small")
            ? d.addClass("modal-container-small")
            : a.hasClass("modal-large") && d.addClass("modal-container-large"),
      ...
      $_document.on("click", 'a[href*="#"]', function (i) {
        if ((m = this.hash)) {
          ...
          ("" !== n[0] && n[0] !== s[0]) ||
            ((g = $(m)).length &&
              (o && t.addClass("headroom--disabled"),
              C.animate(
                { scrollTop: (a = w()) },
                Math.max(
                  400,
                  Math.round(Math.abs($_window.scrollTop() - a) / 5)
                ),
                function () {
                  o &&
                    setTimeout(function () {
